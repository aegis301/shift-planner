...
6. Desktop-first workbench and member app per `docs/decisions/0001-desktop-first-workbench.md` (#107, issues #110 to #125). #109 (slot times as instants), #110 (frontend test harness), #111 (generated API types), and #112 (Radix primitives and design tokens) have landed. Next in the work-plan table is #113 (TanStack Query). #116 (roster change sets) and #119 (token auth) stay independently unblocked. #123 (offline duty activity) can use `Organization.timezone`.
