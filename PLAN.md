...
6. Desktop-first workbench and member app per `docs/decisions/0001-desktop-first-workbench.md` (#107, issues #110 to #125). #109 (slot times as instants), #110 (frontend test harness), and #111 (generated API types) have landed. Next independent issues: #116 (roster change sets), #119 (token auth). #113 can use the generated client. #123 (offline duty activity) can use `Organization.timezone`.
