...
## Next Steps
1. R2 fairness, the solver fixture, SolverRun persistence, the CP-SAT roster model (tier A), solver controls in `/planning` (#76), and shift swap / giveaway requests (#77) are in place. Next: write and implement ArbZG rest / weekly-average encodings (tier B) against the fourth fixture profile, then the swap marketplace UI (#78).
...
- Shift swap marketplace UI and planner approval queue (#78).
