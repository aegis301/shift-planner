...
6. Desktop-first workbench and member app per `docs/decisions/0001-desktop-first-workbench.md` (#107, issues #110 to #125). #109 through #113 have landed (slot times, test harness, generated API types, Radix primitives, TanStack Query). Next in the work-plan table is #114 (route split). #116 (roster change sets) and #119 (token auth) stay independently unblocked. #123 (offline duty activity) can use `Organization.timezone`.
